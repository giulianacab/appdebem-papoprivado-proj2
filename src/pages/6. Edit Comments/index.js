...
{/* FORM */}
      ...
      <section>
          ...
          <form onSubmit={useEffect}>
            <label className={style.label}>Comentário</label>
            ...
            <button className={style.buttonComments} type="submit">Atualizar Comentário</button>
          </form>
        
        {/*     ADD     */}
        <button className={style.buttonComments} onClick={deleteProject}>Deletar</button>
