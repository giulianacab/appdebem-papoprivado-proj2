...
{/* HEADER C/ NOME E FOTO */}
        ...
        <span className='header'>
            <header>
                <img src='../../components/ProfilePic/ProfilePic-Giu.png' className='profilePic'></img>
                <h3 className='openWindow'>PAPO PRIVADO</h3>
                <p className='nameAndLastName'>Giuliana Cabral</p>
            </header>
        </span>
